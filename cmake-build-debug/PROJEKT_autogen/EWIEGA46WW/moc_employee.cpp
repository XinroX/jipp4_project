...
QT_MOC_LITERAL(4, 27, 5) // "query"
    ...
    "Employee\0update\0\0QSqlQuery\0query"
};
...
void Employee::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Employee::*)(QSqlQuery );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Employee::update)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Employee::update(QSqlQuery _t1)
{
