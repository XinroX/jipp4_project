...
QT_MOC_LITERAL(3, 15, 9), // "QSqlQuery"
QT_MOC_LITERAL(4, 25, 5) // "query"

    },
    "Person\0update\0\0QSqlQuery\0query"
};
...
void Person::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Person::*)(QSqlQuery );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Person::update)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Person::update(QSqlQuery _t1)
{
