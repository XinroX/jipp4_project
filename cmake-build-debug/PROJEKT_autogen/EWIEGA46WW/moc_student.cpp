...
QT_MOC_LITERAL(4, 26, 5) // "query"
    ...
    "Student\0update\0\0QSqlQuery\0query"
};
...
void Student::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Student::*)(QSqlQuery );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Student::update)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Student::update(QSqlQuery _t1)
{
