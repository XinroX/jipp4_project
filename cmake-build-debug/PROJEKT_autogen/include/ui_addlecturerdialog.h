/********************************************************************************
** Form generated from reading UI file 'addlecturerdialog.ui'
**
...
#ifndef UI_ADDLECTURERDIALOG_H
#define UI_ADDLECTURERDIALOG_H
...
public:
    ...
    void setupUi(QDialog *AddLecturerDialog)
    {
        if (AddLecturerDialog->objectName().isEmpty())
            AddLecturerDialog->setObjectName(QString::fromUtf8("AddLecturerDialog"));
        AddLecturerDialog->resize(423, 404);
        verticalLayout = new QVBoxLayout(AddLecturerDialog);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        stackedWidget = new QStackedWidget(AddLecturerDialog);
        ...
        buttonBox = new QDialogButtonBox(AddLecturerDialog);
        ...
        retranslateUi(AddLecturerDialog);

        QMetaObject::connectSlotsByName(AddLecturerDialog);
    } // setupUi

    void retranslateUi(QDialog *AddLecturerDialog)
    {
        AddLecturerDialog->setWindowTitle(QCoreApplication::translate("AddLecturerDialog", "Dodaj wyk\305\202adowc\304\231", nullptr));
        label_11->setText(QCoreApplication::translate("AddLecturerDialog", "Numer domu", nullptr));
        label_12->setText(QCoreApplication::translate("AddLecturerDialog", "Miasto", nullptr));
        txtLastName->setInputMask(QString());
        txtZipCode->setInputMask(QCoreApplication::translate("AddLecturerDialog", "99-999;_", nullptr));
        label_13->setText(QCoreApplication::translate("AddLecturerDialog", "Numer lokalu", nullptr));
        label_14->setText(QCoreApplication::translate("AddLecturerDialog", "Ulica:", nullptr));
        txtStreet->setInputMask(QString());
        label_15->setText(QCoreApplication::translate("AddLecturerDialog", "Pa\305\204stwo:", nullptr));
        label_16->setText(QCoreApplication::translate("AddLecturerDialog", "Imi\304\231:", nullptr));
        txtName->setInputMask(QString());
        label_17->setText(QCoreApplication::translate("AddLecturerDialog", "Kod pocztowy:", nullptr));
        label_18->setText(QCoreApplication::translate("AddLecturerDialog", "Nazwisko:", nullptr));
        label_19->setText(QCoreApplication::translate("AddLecturerDialog", "Data urodzenia:", nullptr));
        label_20->setText(QCoreApplication::translate("AddLecturerDialog", "Adres:", nullptr));
...
namespace Ui {
    class AddLecturerDialog: public Ui_AddLecturerDialog {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ADDLECTURERDIALOG_H
